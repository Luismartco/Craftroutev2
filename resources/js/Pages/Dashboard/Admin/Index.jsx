                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-lg shadow p-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Link
                                        href={route('dashboard.admin.view-state')}
                                        className="w-full inline-flex items-center justify-center px-4 py-2 bg-[#3C2F2F] text-white rounded-md hover:bg-[#4B3A3A] transition-colors duration-200"
                                    >
